...
import { switchMap, map, pluck, first, take } from 'rxjs/operators';
...
(() =>{
    ...
    getRequest(`${SW_API}/people/2/`).pipe(
        ...
        //La siguiente linea retorna la Respuesta esperada
        //switchMap(resp => getRequest(resp.species[0]))
        //La siguiente linea retorna la Respuesta esperada con Mayor Dificultad
